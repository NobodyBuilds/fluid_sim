...
nvcc -c source\compute.cu -o source\compute.obj -arch=sm_75  --std=c++17 -O3  -Xptxas=-O3 -Xcompiler="/MD /O2 /Zc:preprocessor /permissive-" -I"D:\visual_studio\fluid_sim\glad\include" -I"D:\visual_studio\fluid_sim\glfw-3.4.bin.WIN64\include"
REM --use_fast_math
